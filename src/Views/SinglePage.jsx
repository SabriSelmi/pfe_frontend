          ...
          <div className="row justify-content-center">
            <div className="col-lg-12">
              <div className="single_product_img">
                <img src={`${api}/file/annonces/${annonce.photo}`} className="img-fluid" alt="Annonce" />
              </div>
            </div>
              ...
              <div className="single_product_text text-center">
                ...
                <div className="card_area row">
                  <div className="col">
                   ...
                   {favorisAdded ? 'Ajoutée aux favoris' : 'Ajouter au favoris'}{' '}
                  ...
                  <div className="col">
                 <div className="contact_seller">
                    <Link to="/Home/chat2" className="btn_3">
